...
#ifndef COMMUNICATIONUI_PROXY_SWIFT_H
#define COMMUNICATIONUI_PROXY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CommunicationUI_Proxy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy35CallCompositeUserReportedIssueProxy")
@interface CallCompositeUserReportedIssueProxy : NSObject
@property (nonatomic, copy) NSString * _Nullable userMessage;
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy22CallHistoryRecordProxy")
@interface CallHistoryRecordProxy : NSObject
@property (nonatomic, copy) NSDate * _Nullable callStartedOn;
@property (nonatomic, copy) NSArray<NSString *> * _Nullable callIds;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21CommunicationUI_Proxy22CallKitRemoteInfoProxy")
@interface CallKitRemoteInfoProxy : NSObject
@property (nonatomic, copy) NSString * _Nullable cxHandleName;
@property (nonatomic, copy) NSString * _Nullable displayName;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21CommunicationUI_Proxy32CallScreenControlBarOptionsProxy")
@interface CallScreenControlBarOptionsProxy : NSObject
@property (nonatomic, copy) NSString * _Nonnull leaveCallConfirmationMode;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21CommunicationUI_Proxy22CallScreenOptionsProxy")
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy27CommunicationCallStateProxy")
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy27CommunicationDismissedProxy")
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy23CommunicationErrorProxy")
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy33CommunicationLocalDataOptionProxy")
...
@property (nonatomic, copy) NSString * _Nullable audioVideoMode;
@property (nonatomic, copy) NSString * _Nullable callScreenTitle;
@property (nonatomic, copy) NSString * _Nullable callScreenSubtitle;
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy30CommunicationLocalizationProxy")
@interface CommunicationLocalizationProxy : NSObject
@property (nonatomic, copy) NSLocale * _Nonnull locale;
@property (nonatomic, copy) NSString * _Nonnull localizableFilename;
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy23CommunicationThemeProxy")
@interface CommunicationThemeProxy : NSObject
@property (nonatomic, strong) UIColor * _Nonnull primaryColor;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class IncomingCallProxy;
@class IncomingCallCancelledProxy;
@class GroupCallObjectProxy;
@class TeamsMeetingObjectProxy;
@class RoomsCallObjectProxy;
@class NSData;

SWIFT_CLASS("_TtC21CommunicationUI_Proxy20CommunicationUIProxy")
...
- (void)dismiss;
- (NSString * _Nonnull)getCallStateCode SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy14DebugInfoProxy")
@interface DebugInfoProxy : NSObject
@property (nonatomic, copy) NSArray<CallHistoryRecordProxy *> * _Nullable callHistoryRecords;
@property (nonatomic, copy) NSArray<NSURL *> * _Nullable logFiles;
@property (nonatomic, strong) VersionsProxy * _Nullable versions;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21CommunicationUI_Proxy20GroupCallObjectProxy")
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy26IncomingCallCancelledProxy")
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy17IncomingCallProxy")
@interface IncomingCallProxy : NSObject
@property (nonatomic, copy) NSString * _Nullable callId;
@property (nonatomic, copy) NSString * _Nullable callerDisplayName;
@property (nonatomic, copy) NSString * _Nullable callerIdentifierMri;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21CommunicationUI_Proxy20RoomsCallObjectProxy")
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy23TeamsMeetingObjectProxy")
@interface TeamsMeetingObjectProxy : NSObject
@property (nonatomic, copy) NSString * _Nonnull teamsMeetingLink;
@property (nonatomic, copy) NSString * _Nonnull displayName;
...
SWIFT_CLASS("_TtC21CommunicationUI_Proxy13VersionsProxy")
@interface VersionsProxy : NSObject
@property (nonatomic, copy) NSString * _Nullable callingUIVersion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
